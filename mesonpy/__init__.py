...
class Project():
    ...
    def __init__(
        ...
        self._meson_native_file = self._build_dir / 'openwrt-native.txt.in'
        self._meson_cross_file = self._build_dir / 'openwrt-cross.txt.in'
...
def _project(config_settings: Optional[Dict[Any, Any]] = None) -> Iterator[Project]:
    ...
    with contextlib.ExitStack() as ctx:
        if build_dir is None:
            build_dir = ctx.enter_context(tempfile.TemporaryDirectory(dir=source_dir))
